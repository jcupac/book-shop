...
const VALIDATION_ERROR_TYPE_URI =
  'https://api.jcupac.example/errors/validation-error';
const RESOURCE_NOT_FOUND_TYPE_URI =
  'https://api.jcupac.example/errors/resource-not-found';
const BAD_REQUEST_TYPE_URI =
  'https://api.jcupac.example/errors/bad-request';
const INTERNAL_SERVER_ERROR_TYPE_URI =
  'https://api.jcupac.example/errors/internal-server-error';
