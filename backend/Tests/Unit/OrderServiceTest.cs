...
using Moq;
using Jcupac.BookShop.Backend.Core.Dtos;
using Jcupac.BookShop.Backend.Core.Dtos.External;
using Jcupac.BookShop.Backend.Core.Entities;
using Jcupac.BookShop.Backend.Core.Exceptions;
using Jcupac.BookShop.Backend.Core.Services;
using Jcupac.BookShop.Backend.Core.Services.External;
using Jcupac.BookShop.Backend.Data;
using Xunit;

namespace Jcupac.BookShop.Backend.Tests.Unit;
