...
using Jcupac.BookShop.Backend.Core.Exceptions;

namespace Jcupac.BookShop.Backend.Api.Exception;

public class GlobalExceptionHandler : IExceptionHandler
{
    private const string ProblemJsonContentType = "application/problem+json";

    private const string ValidationErrorTypeUri = "https://api.jcupac.com/errors/validation-error";
    private const string ResourceNotFoundTypeUri = "https://api.jcupac.com/errors/resource-not-found";
    private const string InternalServerErrorTypeUri = "https://api.jcupac.com/errors/internal-server-error";
