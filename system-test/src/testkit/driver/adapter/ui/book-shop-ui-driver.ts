...
import { BookShopUiClient } from './client/BookShopUiClient.js';
import { NewOrderPage } from './client/pages/NewOrderPage.js';

export class BookShopUiDriver implements BookShopDriver {
  private readonly client: BookShopUiClient;
