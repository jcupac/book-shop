...
public class ConfigurationLoader {
    ...
    public static Configuration load(Environment environmentMode, ExternalSystemMode externalSystemMode,
        ...
        var bookShopUiBaseUrl = getEnvVarOrDefault("MYSHOP_UI_BASE_URL" + suffix,
                getNestedStringValue(config, "test", "bookShop", "ui", BASE_URL));
        var bookShopApiBaseUrl = getEnvVarOrDefault("MYSHOP_API_BASE_URL" + suffix,
                getNestedStringValue(config, "test", "bookShop", "api", BASE_URL));
        ...
        return new Configuration(bookShopUiBaseUrl, bookShopApiBaseUrl, erpBaseUrl, clockBaseUrl, taxBaseUrl,
