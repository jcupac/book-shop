package com.jcupac.bookshop.testkit.driver.adapter.ui.client.pages;

import com.jcupac.bookshop.testkit.driver.adapter.shared.client.playwright.PageClient;

public class HomePage extends BasePage {
    private static final String BOOK_SHOP_BUTTON_SELECTOR = "a[href='/new-order']";
    ...
    public NewOrderPage clickNewOrder() {
        pageClient.click(BOOK_SHOP_BUTTON_SELECTOR);
