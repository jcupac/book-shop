package com.jcupac.bookshop.testkit.driver.adapter.ui.client;
...
public class BookShopUiClient implements AutoCloseable {
    ...
    public BookShopUiClient(String baseUrl, Browser browser) {
