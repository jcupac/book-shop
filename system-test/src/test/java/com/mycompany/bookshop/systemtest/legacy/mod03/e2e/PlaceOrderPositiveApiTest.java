...
class PlaceOrderPositiveApiTest extends BaseE2eTest {
    ...
    void shouldPlaceOrderForValidInput() throws Exception {
        ...
        var placeOrderUri = URI.create(getBookShopApiBaseUrl() + "/api/orders");
        ...
        var placeOrderResponse = bookShopApiHttpClient.send(placeOrderRequest, HttpResponse.BodyHandlers.ofString());
        ...
        var viewOrderUri = URI.create(getBookShopApiBaseUrl() + "/api/orders/" + orderNumber);
        ...
        var viewOrderResponse = bookShopApiHttpClient.send(viewOrderRequest, HttpResponse.BodyHandlers.ofString());
