package com.jcupac.bookshop.systemtest.architecture;
...
class ArchitectureRulesTest {
    ...
    private static final JavaClasses TESTKIT = new ClassFileImporter()
            ...
            .importPackages("com.jcupac.bookshop.testkit");
    ...
    /** A10 — every BookShopDriver operation takes a *Request and returns Result<*Response, …> (strict, Q2(b)). */
    @Test
    void everyDriverMethodTakesRequestAndReturnsResponse() {
        ArchRule rule = methods()
                .that().areDeclaredInClassesThat().haveSimpleName("BookShopDriver")
                .should(takeRequestAndReturnResponse())
                .as("Every BookShopDriver method must take a single *Request and return Result<*Response, …>");
